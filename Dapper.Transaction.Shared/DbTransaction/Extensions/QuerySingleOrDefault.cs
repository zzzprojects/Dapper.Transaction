...
namespace Dapper.Transaction
{
	public static partial class DbTransactionExtensions
	{
		...
		/// </returns>
		public static object QuerySingleOrDefault(this IDbTransaction transaction, Type type, string sql, object param = null, int? commandTimeout = null, CommandType? commandType = null)
		{
			return InternalGetConnection.GetConnection(transaction).QuerySingleOrDefault(type, sql, param, transaction, commandTimeout, commandType);
		}
	}
}